...
export const config = {
  light: vars({
    ...
    /* Arkaic Tokens */
    "--color-arkaic-background": "248 250 252",
    "--color-arkaic-foreground": "15 23 42",
    "--color-arkaic-muted": "118 118 118",
    "--color-arkaic-primary": "113 56 113",
    "--color-arkaic-primary-foreground": "248 250 252",
    "--color-arkaic-accent": "247 147 26",
    "--color-arkaic-fill": "255 255 255",
    "--color-arkaic-border": "118 118 118",
    "--color-arkaic-shadow": "183 121 182",
