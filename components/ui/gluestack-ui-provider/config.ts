...
export const config = {
  light: vars({
    ...
    "--color-arkaic-background": "255 255 255",
    "--color-arkaic-foreground": "26 26 26",
    "--color-arkaic-muted": "150 150 150",
    "--color-arkaic-primary": "247 147 26",
    "--color-arkaic-primary-foreground": "255 255 255",
    "--color-arkaic-accent": "0 160 214",
    "--color-arkaic-fill": "76 175 80",
    "--color-arkaic-border": "224 224 224",
    "--color-arkaic-shadow": "183 28 28",
  ...
  dark: vars({
    ...
    /* Arkaic Tokens – Subito.it inspired */
    "--color-arkaic-background": "26 26 26",
    "--color-arkaic-foreground": "245 245 245",
    "--color-arkaic-muted": "158 158 158",
    "--color-arkaic-primary": "255 167 38",
    "--color-arkaic-primary-foreground": "255 255 255",
    "--color-arkaic-accent": "41 182 230",
    "--color-arkaic-fill": "38 38 38",
    "--color-arkaic-border": "97 97 97",
    "--color-arkaic-shadow": "183 28 28",
