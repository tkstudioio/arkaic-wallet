...
const actionsheetContentStyle = tva({
  base: 'items-center rounded-tl-3xl rounded-tr-3xl p-2 bg-arkaic-background web:pointer-events-auto web:select-none shadow-lg pb-safe max-h-[70%]',
});

const actionsheetItemStyle = tva({
  base: 'w-full flex-row items-center p-3 rounded-sm data-[disabled=true]:opacity-40 data-[disabled=true]:web:pointer-events-auto data-[disabled=true]:web:cursor-not-allowed hover:bg-arkaic-fill active:bg-arkaic-fill data-[focus=true]:bg-arkaic-fill web:data-[focus-visible=true]:bg-arkaic-fill data-[checked=true]:bg-arkaic-fill',
});

const actionsheetItemTextStyle = tva({
  base: 'text-arkaic-foreground font-normal font-body tracking-md text-left mx-2',
  variants: {
    isTruncated: {
      true: '',
    },
